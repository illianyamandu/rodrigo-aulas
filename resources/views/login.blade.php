    ...
    <div
        ...
        <form method="POST" class="space-y-4" action="{{ route('login.store') }}">
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit"
                    class="inline-flex items-center cursor-pointer justify-center px-5 py-2 rounded-sm text-sm font-medium bg-[#1b1b18] text-white hover:bg-black dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white border border-[#19140035] dark:border-[#eeeeec] transition-all">
                    Fazer Login
                </button>
            </div>
        </form>
